  ...
  */
  ...
  summit_action: function (e) {
    ...
    if (this.data.title && this.data.changeitems && this.data.urgentitems && this.data.contact_name && this.data.tel && this.data.hopetime && this.data.infoitems && this.data.content && this.data.slr_name &&
      this.data.slr_id) {  
    wx.request({  
